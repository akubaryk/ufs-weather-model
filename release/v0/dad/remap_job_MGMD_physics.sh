...
. /scratch1/NCEPDEV/global/Henry.Juang/2019/NEMSfv3gfs/release/v0/dad/config/workflow.sh repro.config-MGMD-physL150

export DATA=/scratch1/NCEPDEV/stmp2/Henry.Juang/C96MGMD_physics2017011906/gfs.20170119/06/
